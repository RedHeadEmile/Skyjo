...
export class SkyjoRoomViewModel implements ISkyjoRoomViewModel {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.currentTurnEndAt = _data["currentTurnEndAt"];
    ...
    toJSON(data?: any) {
        ...
        data["currentTurnEndAt"] = this.currentTurnEndAt;
...
export enum SkyjoGameActionViewModelType {
    ...
    EXCHANGE_WITH_DRAWN_CARD = "EXCHANGE_WITH_DRAWN_CARD",
    IGNORE_DRAWN_CARD = "IGNORE_DRAWN_CARD",
